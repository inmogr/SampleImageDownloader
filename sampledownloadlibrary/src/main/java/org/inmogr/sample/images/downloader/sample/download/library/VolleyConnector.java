package org.inmogr.sample.images.downloader.sample.download.library;
    ...
    class ResponseErrorListener implements Response.ErrorListener {
        ...
        public void onErrorResponse(VolleyError error) {
            if (view == null) {}
                ...
                Snackbar.make(view, "Not connected to the Internet", Snackbar.LENGTH_SHORT);
            } else if (error instanceof TimeoutError) {
                Snackbar.make(view, "Failed to get response from the server", Snackbar.LENGTH_SHORT);
            } else if (error instanceof AuthFailureError) {
                Snackbar.make(view, "Not authenticated", Snackbar.LENGTH_SHORT);
            } else if (error instanceof ServerError) {
                Snackbar.make(view, "Server encountered an error", Snackbar.LENGTH_SHORT);
            } else if (error instanceof NetworkError) {
                Snackbar.make(view, "Network failed to complete the request", Snackbar.LENGTH_SHORT);
            } else if (error instanceof ParseError) {
                Snackbar.make(view, "Response does not meet the request", Snackbar.LENGTH_SHORT);
            }
            /**
